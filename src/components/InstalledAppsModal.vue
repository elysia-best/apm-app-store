<template>
  ...
  >
    ...
    >
      <div
        class="w-full max-w-4xl max-h-[85vh] overflow-y-auto scrollbar-nowidth scrollbar-thumb-slate-200 dark:scrollbar-thumb-slate-700 rounded-3xl border border-white/10 bg-white p-6 shadow-popup dark:border-slate-800 dark:bg-slate-900"
      >
